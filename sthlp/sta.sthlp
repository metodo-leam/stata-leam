...
{p 8 32 2}
{helpb sta_freq: sta, data(freq)}{space 8}for frequency data

{p 8 32 2}
{helpb sta_pt: sta, data(pt)}{space 10}for person-time data
...
{p 4 4}
Execute {cmd: net install sta, from("https://raw.githubusercontent.com/metodo-leam/stata/master")} for install. 
...
{p 4}
Version 1.2.4 {hline 2} 15 September 2025
