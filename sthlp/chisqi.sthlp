...
{p 4 4}
Execute {cmd: net install chisqi, from("https://raw.githubusercontent.com/metodo-leam/stata/master")} for install. 
...
net install chisqi, from("https://raw.githubusercontent.com/metodo-leam/stata/master"){p_end}
