...
{p 4 4}
Execute {cmd: net install cir, from("https://raw.githubusercontent.com/metodo-leam/stata/master")} for install. 
...
{p 4 4}{stata "use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/CreaHemo.dta":. use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/CreaHemo.dta}{p_end}
...
{p 4}
Version 1.1.3 {hline 2} 15 December 2022
...
V1.1.3. Bellaterra: Universitat Aut{c o'g}noma de Barcelona; 2022.{break}
Available executing from Stata: {break}
net install cir, from("https://raw.githubusercontent.com/metodo-leam/stata/master"){p_end}
