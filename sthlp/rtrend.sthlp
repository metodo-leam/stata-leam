...
{synopt :{opt ord:inal(string)}}ordinal variable:{break}
{bf:expo} Exposure variable (default){break}
{bf:resp} Response variable{p_end}
{synoptline}
...
{p 4 4}
Execute {cmd: net install rtrend, from("https://raw.githubusercontent.com/metodo-leam/stata/master")} for install. 
...
{stata "use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/SmokeApgar.dta":. use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/SmokeApgar.dta}{break}
...
{stata "use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/SmokeApgarAge.dta":. use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/SmokeApgarAge.dta}{break}
...
{stata "use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/SmokeBladder.dta":. use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/SmokeBladder.dta}{break}
...
{stata "use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/ArsenicRespiratoryYear.dta":. use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/ArsenicRespiratoryYear.dta}{break}
...
{p 4}
Version 1.3.4 {hline 2} 15 December 2022
...
V1.3.4. Bellaterra: Universitat Aut{c o'g}noma de Barcelona; 2022.{break}
Available executing from Stata: {break}
net install rtrend, from("https://raw.githubusercontent.com/metodo-leam/stata/master"){p_end}
