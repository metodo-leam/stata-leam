...
{p 4 4}
Execute {cmd: net install rndseq, from("https://raw.githubusercontent.com/metodo-leam/stata/master")} for install. 
...
net install rndseq, from("https://raw.githubusercontent.com/metodo-leam/stata/master"){p_end}
