...
{p 4 4}
Execute {cmd: net install dtroc, from("https://raw.githubusercontent.com/metodo-leam/stata/master")} for install. 


{marker examples}{...}
{title:Examples}

{p 4 4}{stata "use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/GlucoseDiabetes.dta":. use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/GlucoseDiabetes.dta}{p_end}
...
{p 4}
Version 1.1.5 {hline 2} 15 December 2022
...
V1.1.5. Bellaterra: Universitat Aut{c o'g}noma de Barcelona; 2022.{break}
Available executing from Stata: {break}
net install dtroc, from("https://raw.githubusercontent.com/metodo-leam/stata/master"){p_end}
