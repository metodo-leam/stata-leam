...
{p 4 4}
Execute {cmd: net install mar, from("https://raw.githubusercontent.com/metodo-leam/stata/master")} for install. 
...
{p 4 4}
The zip file available for download on {browse "https://raw.githubusercontent.com/metodo-leam/stata/master/dta/Comando_mar_para_Stata.zip"} contains a pdf file with
...
the direct download fails, copy the download link (https://raw.githubusercontent.com/metodo-leam/stata/master/dta/Comando_mar_para_Stata.zip) and paste in the 
address bar of your web browser.

{it:RAW data}
{p 4 4}{stata "use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/AngMio.dta":. use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/AngMio.dta}{p_end}
{p 4 4}{cmd:. mar raw or, forest(se) method(fem) keep nst("Enzima convertidora de la angiotensina e infarto de miocardio")}{p_end}

{it:SST data}
{p 4 4}{stata "use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/CancerUtero.dta":. use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/CancerUtero.dta}{p_end}
...
{p 4}
Version 1.4.6 {hline 2} 15 December 2022
