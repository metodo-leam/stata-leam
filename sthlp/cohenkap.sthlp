...
{p 4 4}
Execute {cmd: net install cohenkap, from("https://raw.githubusercontent.com/metodo-leam/stata/master")} for install.


{marker examples}{...}
{title:Examples}

{p 4 4}{stata "use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/kappa_data.dta":. use https://raw.githubusercontent.com/metodo-leam/stata/master/dta/kappa_data.dta}{p_end}
...
{p 4}
Version 1.1.8 {hline 2} 15 September 2025
...
V1.1.8. Bellaterra: Universitat Aut{c o'g}noma de Barcelona; 2025.{break}
Available executing from Stata: {break}
net install cohenkap, from("https://raw.githubusercontent.com/metodo-leam/stata/master"){p_end}
